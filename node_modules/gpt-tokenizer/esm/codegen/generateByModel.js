...
const insertHeaderAfterDirectives = (content, headerLines) => {
...
await Promise.all(Object.entries(models).map(async ([_modelName, modelData]) => {
    ...
    const supportedFeatures = modelData.supported_features;
    const supportsFunctionCalling = Array.isArray(supportedFeatures) &&
    ...
    let baseContent = isChatModel
        ? template
            ...
            .replaceAll('../bpeRanks/cl100k_base.js', `../bpeRanks/${bpeModuleName}.js`)
