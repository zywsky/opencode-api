...
// prettier-ignore
const api = GptEncoding_js_1.GptEncoding.getEncodingApiForModel('o3-deep-research-2025-06-26', () => o200k_base_js_1.default, { name: "o3-deep-research-2025-06-26", slug: "o3-deep-research-2025-06-26", performance: 5, latency: 1, modalities: { input: ["text", "image"], output: ["text"] }, context_window: 200000, max_output_tokens: 100000, knowledge_cutoff: new Date(1717200000000), supported_features: ["streaming", "file_uploads", "image_input", "prompt_caching", "evals", "stored_completions"], supported_endpoints: ["responses", "batch"], reasoning_tokens: true, price_data: { main: { input: 15, cached_output: 7.5, output: 60 }, batch: { input: 7.5, output: 30 } } });
