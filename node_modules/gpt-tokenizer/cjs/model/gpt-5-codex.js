...
// prettier-ignore
const api = GptEncoding_js_1.GptEncoding.getEncodingApiForModel('gpt-5-codex', () => o200k_base_js_1.default, { name: "gpt-5-codex", slug: "gpt-5-codex", performance: 4, latency: 3, modalities: { input: ["text", "image"], output: ["text"] }, context_window: 400000, max_output_tokens: 128000, max_input_tokens: 272000, knowledge_cutoff: new Date(1727654400000), supported_features: ["streaming", "structured_outputs", "function_calling", "image_input", "web_search", "prompt_caching"], supported_endpoints: ["responses"], reasoning_tokens: true, price_data: { main: { input: 1.25, output: 10 } } });
