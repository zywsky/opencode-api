...
// prettier-ignore
const api = GptEncoding_js_1.GptEncoding.getEncodingApiForModel('gpt-5-chat-latest', () => o200k_base_js_1.default, { name: "gpt-5-chat-latest", slug: "gpt-5-chat-latest", performance: 3, latency: 3, modalities: { input: ["text", "image"], output: ["text"] }, context_window: 128000, max_output_tokens: 16384, max_input_tokens: 272000, knowledge_cutoff: new Date(1727654400000), supported_features: ["function_calling", "structured_outputs", "streaming", "image_input"], supported_endpoints: ["chat_completions", "responses"], reasoning_tokens: false });
